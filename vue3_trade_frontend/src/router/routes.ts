...
export const asnycUserRoute = [
  {
    ...
    children: [
      ...
      {
        path: `/user/commodity/mine`,
        component: () => import("@/views/user/commodityMine/index.vue"),
        name: "commodityMine",
        meta: {
          title: "我的发布",
          icon: "List",
      ...
      {
        path: `/user/commodity/publish`,
        component: () => import("@/views/user/commodityPublish/index.vue"),
