  ...
  <div class="commodity-admin">
    ...
    <el-card>
      <el-table :data="commodityList" style="width: 100%" :loading="loading">
        <el-table-column prop="commodityName" label="账号名称" />
        <el-table-column
        ...
        />
        <el-table-column label="账号封面" prop="commodityAvatar" width="100px">
        ...
        <el-table-column
          ...
          show-overflow-tooltip
        />
        <el-table-column prop="commodityTypeName" label="账号分类名称" />
    ...
    >
      <el-form :model="editForm" ref="editFormRef" label-width="100px">
        ...
        <el-form-item label="账号简介" prop="commodityDescription">
          <el-input type="textarea" v-model="editForm.commodityDescription" />
        </el-form-item>
        <el-form-item label="账号封面" prop="commodityAvatar">
          <el-input
        ...
        <el-form-item label="账号库存" prop="commodityInventory">
          <el-input-number
